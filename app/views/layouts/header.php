                ...
                <div class="flex items-center space-x-4">
                    <?php if (isset($_SESSION['user_id'])): ?>
                        ...
                        <div class="relative group">
                            <a href="/invoice/info" class="px-4 py-2 text-gray-700 hover:text-blue-600 transition-colors inline-flex items-center">
                                发票管理
                            ...
                            <div class="absolute left-0 mt-2 w-48 bg-white rounded-md shadow-lg opacity-0 invisible group-hover:opacity-100 group-hover:visible transition-all duration-200 z-50">
                                <div class="py-2">
                                    <a href="/invoice/info" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">发票资料维护</a>
                                    <a href="/invoice/orders" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">订单管理</a>
                                    <a href="/invoice/applications" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">开票申请</a>
                                    <a href="/invoice/invoices" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100">已开发票</a>
                                </div>
                            </div>
                        </div>
